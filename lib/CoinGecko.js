 ...
 * @author Phillip Rumple <phillip@somee.social>
 * @description A Node.js wrapper for the CoinGecko API PRO with no dependencies. For more information, visit: https://www.coingecko.com/en/developers/dashboard/user_guide
 * @example
 *     const CoinGecko = require('coingecko-api');
 *     const CoinGeckoClient = new CoinGecko();
 * @param CG_API_KEY {string} The Coin Gecko API key (set this in your environment)
 * @public
 * @version 1.0.10
 * @license MIT
 * @kind class
...
class CoinGecko {
   ...
   * @param {string} API_KEY this should be set in your process environment as CG_API_KEY, not passable - if you don't specify a key, it will fail
  ...
  _buildRequestOptions(path, params) {
    ...
    else path = `/api/v${Constants.API_VERSION}${path}?${params}&x_cg_pro_api_key=${Constants.API_KEY}`;
