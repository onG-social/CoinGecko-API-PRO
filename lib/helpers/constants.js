 ...
 * @kind constant
 */
const BASE = process.env.CG_API_URL || 'https://api.coingecko.com/api/';

/**
 * @description The host of the CoinGecko API
 * @kind constant
 */
const HOST = new URL(BASE).hostname || 'api.coingecko.com';
...
/**
 * @description The api key for coin gecko pro plans
 * @kind constant
 */
